...
def test_losses_and_excesses_revision_view():
    ...
    Потери - {revision.summary.total_loss.percent_of_revenue}% / {revision.summary.total_loss.amount} руб
    Неучтённые - {revision.summary.unaccounted_losses.percent_of_revenue}% / {revision.summary.unaccounted_losses.amount} руб
